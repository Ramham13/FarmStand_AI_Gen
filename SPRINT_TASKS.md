...
- [x] Add in-app notification center - view reservation status, waitlist updates (complements existing email notifications) ✅ DONE
- [x] Refine cart drawer mobile experience - full-screen slide-up on small screens ✅ DONE

## Priority 4: Mobile & Performance
- [x] Lazy load product images with blur placeholder ✅ DONE (BlurImage component)
- [x] Add skeleton loading states for farm/product detail pages ✅ DONE
- [x] Optimize cart drawer for mobile (slide-up fullscreen on small screens) ✅ DONE

## Priority 5: Technical Debt & Security
- [x] Add proper error boundaries per route (farm, product, dashboard, profile, favorites) ✅ DONE
